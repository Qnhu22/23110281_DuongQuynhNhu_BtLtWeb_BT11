...
<body>
    ...
    <a href="<c:url value='/user/category/add'/>">Thêm category</a>
    <table border="1">
        <tr>
            <th>ID</th>
            <th>Tên Category</th>
            ...
            <tr>
                ...
                <td>
                    <c:if test="${cate.user.userId == sessionScope.user.userId}">
                        <a href="<c:url value='/user/category/edit?id=${cate.categoryId}'/>">Sửa</a> |
                        <a href="<c:url value='/user/category/delete?id=${cate.categoryId}'/>"
