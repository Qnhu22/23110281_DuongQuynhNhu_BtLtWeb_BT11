...
<head>
    ...
    <style>
        ...
        .card {
            border-radius: 16px; box-shadow: 0px 6px 20px rgba(0,0,0,0.2);
            background: #fff; width: 400px; padding: 30px; position: relative;
        }
        h2 { color: #0d6efd; font-weight: bold; text-align: center; }
