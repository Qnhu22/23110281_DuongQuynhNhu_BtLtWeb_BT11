    ...
    <tbody>
      <c:forEach items="${listcate}" var="cate" varStatus="stt">
        <tr>
          ...
          <td>
            <a class="btn btn-sm btn-warning" href="<c:url value='/admin/category/edit?id=${cate.categoryId}'/>">Sửa</a>
            <a class="btn btn-sm btn-danger" href="<c:url value='/admin/category/delete?id=${cate.categoryId}'/>"
